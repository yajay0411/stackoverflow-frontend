                        ...
                        <div className='m-2 w-full'>
                            ...
                            <div className='w-full flex flex-col justify-center items-center p-2'>
                                {AllQuestions && AllQuestions.map(({ _id, upVote, downVote, noOfAnswers, postedOn, questionTitle, questionTags, userPosted
                                    ...
                                    <div
                                        key={_id}
                                        className='w-full bg-[#fdf7e2] flex flex-col-reverse md:flex-row justify-between items-start md:items-center p-2 border-b-2 border-[#f1e5bc]'>
                                        <div className='flex sm:flex-col lg:flex-row justify-evenly sm:items-center w-[150px]'>
                                        ...
                                        <div className='text-left md:w-[300px]'>
